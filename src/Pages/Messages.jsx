    ...
    <div className='max-w-5xl mx-auto px-4 py-12'>
      ...
      <div>
        <p>
          ...
          place of Bhojpur district, {appData.country}. I am the second child among 6
        ...
        <br></br>
        <p>
          While I was studying in grade 9, unfortunately I developed pain in my
          backbone. The paining situation went worsen than the worse day by day.
          I ended up going to school. In remote place, where traditional belief
          and superstition were highly rooted in the villages in those days. As
          advices received from our neighbors and friends my family took me to
          traditional healers for my treatment. They began to take me to them
          daily-sometimes, one after other persons. Innumerable chickens,
          Pigeons including vegetables were sacrified but it didn't help
          changing anything in my condition. The more I was taken to traditional
          healers more my condition got worsen.
        </p>
        <br></br>
        <p>
          ...
          vain as I couldn’t feel any improvement in my bodily condition. Again
          I put a proposal for requesting my family member to take me to
        ...
        <p>
          ...
          bus ticket and send me to Sunsari district. When I reached there
          ...
          we went to Nepalgunj finally.
        </p>
        <br></br>
        <p>
          I collected one wheelchair from the health camp. We came back Sunsari
          with that wheelchair for me. With help of the wheelchair I improved my
          mobility there. I admitted a local school and continued my schooling
          smoothly. When my School Leaving Certificate (SLC) examination was
          over I was alone, my father had gone to village during those days. So,
          taking advantage of this time I sold 2 quintals of rice and went to
          Kathmandu with my younger brother, Prem Thapa lying that we would be
          going to visit Kathmandu. In 3 days journey we reached Kathmandu.
          After reaching here, we visited to one of the organizations working
          for the rehabilitation of the persons with disability where medical
          treatment facility to was available. To examine myself quickly I
          requested the physiotherapist, Krisha Gurung. But he refused
          admitting me saying that I would wait more 3 months for my turn. Then
          I stayed outside with sadness cursing my fate. 
        </p>
        <br></br>
        <p>
          In the main time, I had seen the visitors coming there would greet the staff by saying
          (Namaste) and how are you and so on. In return, the welcoming behavior
          from staff would be showed. But I had just come from village, became
          shy, didn’t know to say Namaste and so forth. Might be it was the
          reason why the staff didn't come in front of me and didn’t talked with
          me. So I thought I must be proactive saying Namaste, how are you etc.
          Then I told Namaste to one of the foreign volunteers, then she also
          replied it and came near to me, sat near me and asked me what was my
          problem. Then I turned out my story and told that I did not get
          admission in the hospital. Then immediately she went inside and
          brought the physiotherapist out and requested him to take my admission
          then Krisha Gurung accepted her request and admitted me for 6 months.
          I thanked her so much. Then my physiotherapy begun and within 3 month
          I was able to move a little. They were also happy and slowly were
          improving. The result of SLC exam came out. I knew that I was fail in
          English subject. With this result, I did not lose my hope and efforts.
          So I reappeared the exam too next year and passed SLC, an iron gate
          for a carrer development here in Nepal. While I completed course of
          physiotherapy, I engaged to paid work in the same organization to
          earn little money. I admitted a college nearby to continue my
          education. But seeing me a disable the public vehicle would not stop
          while going to college, I use to fall a lot when getting into the
          vehicle. Fighting this situation I was able to continue college level
          study for 3 years. Then after due to my technical problem I was
          compelled to discontinue the study. Then we few friends sat together
          discuss to establish an organization to be run by ourselves. We were
          able to establish an organization named Conflict Victim and Disable
          Society(CVDS). This organization has been registered with the local
          government of Nepal under NGO registration Act. Soon also affiliated
          with social welfare council's started working as the founder president
          in the same year I had an intercaste marriage to very generous lady.
          A year after we were lucky to have a baby boy. Now he is studying in
          class 9 but corana is distrub now. He is in home. We realized
          there are children and adult with intellectual disability and multiple
          ...
          in the street, kept in house with providing basic facilities and
          other orphans. We have run a residential rehabilitation facility. A
          team of 9 staffs have dedicated to support this 50 children
          till date providing necessary care and support - rendering physiotherapy
          service, regular health check up from doctor, special
          education classes etc.
        </p>
        <br></br>
        <p>
          I would like to end my autobiography here appealing all of you for
          your generous support to lifting thousand of the persons with
          disability and people living in extreme poverty, hunger, illiteracy,
          capacity building training and health treatment in our communities.
          Being a social worker myself With a strong determination and
          conviction, through my organization I would like to concentrate and
          focus promoting the livelihood of 1000 persons with disability and
          marginalized people in life time period. Certainly we are nothing
          without begging your hands and heart with us.
        </p>
        <br></br>
        <p>
          Thank You. Yub Raj Thapa President of Conflict Victim and Disable
          Society. <br/>
           {appData.municipality} Municipality-{appData.wardno},{" "}  
           {appData.address1},{" "} {appData.address2},{" "} {appData.city} <br/>
           Tel:{appData.phone1}/{appData.phone2}<br/> 
           Email:
          {appData.email2} Facebook: {appData.facebook}
        </p>
