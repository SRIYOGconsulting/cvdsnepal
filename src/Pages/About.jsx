  ...
  return (
    <div>
      ...
      <p>
        ...
        overshadow the prejudice prevalent in Nepal regarding the image of
      ...
      <div>
        <p>
          am Yub Raj Thapa born in 23rd march, 1973 in Hasanpur VDC, a remote
        ...
        <p>
          ...
          Pigeons including vegetables WERE SACRIFICED BUT IT DIDN’T help
        ...
        <p>
          ...
          requested the phisio therapist, krisha Gurung. But he refused
          admitting me saying that I would wait more 3 months for my turn. Then
          I stayed outside with sadness cursing my fate. In the main time,
        </p>
        <br></br>
        <p>
          I had seen the visitors coming there would greet the staff by saying
          ...
          brought the phios therapy out and requested him to take my admission
          then krisha Gurung accepted her request and admitted me for 6 months.
          I thanked her so much. Then my phisio therapy begun and within 3 month
          ...
          for a carrier development here in Nepal. While I completed course of
          phisio therapy, I engaged to paid work in the same organization to
          ...
          society. This organization has been registered with the local
